        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Welcome to FreshVibes! You can now start uploading and sharing your content.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 14,
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 24),
                    Text(
                      'Upload photos and videos, watch amazing content,\nand connect with creators worldwide.',
                      style: TextStyle(
                        fontSize: 16,
                    ...
                    _buildFeature(
                      ...
                      'Unlimited uploads',
                      'Share photos and videos without limits',
                    ),
                    const SizedBox(height: 20),
                    _buildFeature(
                      Icons.hd_outlined,
                      'HD quality',
                      'Watch and upload in high definition',
                    ),
                    const SizedBox(height: 20),
                    _buildFeature(
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Start your journey with FreshVibes',
